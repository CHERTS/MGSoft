...
{ #                                                                          # }
{ #  MGHotKeyManager v1.0.0 - Менеджер Горячих клавиш                        # }
{ #                                                                          # }
{ #  License: GPLv3                                                          # }
{ #                                                                          # }
...
const
  // Мультимедийные клавиши в Windows 2000/XP  (взято из winuser.h и переименовано во избежании конфликтов)
  // Смотрите также: http://msdn.microsoft.com/en-us/library/windows/desktop/dd375731%28v=vs.85%29.aspx
...
const
  ...
  // Нелокализованные (!) имена модификаторов
  ModName_Shift = 'Shift';
  ModName_Ctrl  = 'Ctrl';
  ModName_Alt   = 'Alt';
  ModName_Win   = 'Win';
...
var
  ...
  // Локализованные (!) имена модификаторов для Английских названий
...
// Получает указатель с горячей клавишей и модификатором
function GetHotKey(Modifiers, Key: Word): Cardinal;
const
  VK2_SHIFT   =  32;
  VK2_CONTROL =  64;
